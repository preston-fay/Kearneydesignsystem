        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center gap-3">
              <Logo variant={theme === 'dark' ? 'white' : 'slate'} size="sm" />
              <span className="text-sm text-muted-foreground hidden sm:inline">Design System</span>
            </div>
      ...
      <footer className="border-t mt-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
            <p>© 2026 Kearney Design System - Comprehensive reference for all deliverables</p>
            <p>Light & Dark themes • Accessible • Production-ready</p>
          </div>
        </div>
      </footer>
    </div>
